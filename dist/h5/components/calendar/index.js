...
export default class AtCalendar extends Taro.Component {
  ...
  render() {
    ...
    const { validDates, marks, subscripts, format, minDate, maxDate, isSwiper, className, hideArrow, isVertical, monthFormat, selectedDates } = this.props;
