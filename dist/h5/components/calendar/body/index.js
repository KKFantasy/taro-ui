...
export default class AtCalendarBody extends Taro.Component {
  constructor(props) {
    ...
    const { validDates, marks, subscripts, format, minDate, maxDate, generateDate, selectedDate, selectedDates } = props;
  ...
  componentWillReceiveProps(nextProps) {
    const { validDates, marks, subscripts, format, minDate, maxDate, generateDate, selectedDate, selectedDates } = nextProps;
    this.generateFunc = generateCalendarGroup({
      validDates,
      format,
      minDate,
